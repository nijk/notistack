...
exports.variantIcon = exports.TransitionComponent = exports.muiClasses = exports.getTransitionDirection = exports.defaultAnchorOrigin = exports.capitalise = undefined;
...
var notistackClasses = ['base', 'variantSuccess', 'variantError', 'variantInfo', 'variantWarning', 'message', 'icon'];
 ...
 */
var muiClasses = function muiClasses(classes) {
    return Object.keys(classes).filter(function (key) {
        return !notistackClasses.includes(key);
